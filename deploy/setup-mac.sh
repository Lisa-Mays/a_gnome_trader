...
# Expects alongside this script: a_gnome_trader-darwin-arm64, a_gnome_trader-darwin-amd64,
...
ARCH=$(uname -m)
if [ "$ARCH" = "arm64" ]; then BIN=a_gnome_trader-darwin-arm64; else BIN=a_gnome_trader-darwin-amd64; fi
